...
<nav>
    ...
    <ul>
        ...
        <li><a href="<?php echo base_url(); ?>"><span class="lnr lnr-clock"></span></a></li>
        <li><a href="<?php echo base_url(); ?>"><span class="lnr lnr-database"></span></a></li>
        <li><a href="<?php echo base_url(); ?>"><span class="ion ion-ios-gear-outline"></span></a></li>
        <!-- TODO: Add link -->
        <li><a href="#" id="logout-btn" class="lnr lnr-exit"></a></li>
    </ul>
